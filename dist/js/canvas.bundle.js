...
Star.prototype.update = function () {
  this.draw(); // When star hits the bottom screen
...
MiniStar.prototype.update = function () {
  this.draw(); // When ball hits the bottom screen
...
function animate() {
  ...
  if (ticker % randomSpawnRate == 0) {
    ...
    randomSpawnRate = _utils__WEBPACK_IMPORTED_MODULE_0___default.a.randomIntFromRange(300, 500);
  }
}
